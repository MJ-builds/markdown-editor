  ...
  return (
    <div>
      <div
        className={
          previewToggle
            ? "flex items-center justify-between font-r-reg font-medium h-[42px] bg-[#1D1F22] p-4 text-sm tracking-[2px] border-l-[1px] border-[#5A6069]"
            : "flex items-center justify-between font-r-reg font-medium h-[42px] bg-[#1D1F22] p-4 text-sm tracking-[2px]"
        }
      >
        PREVIEW
        <button
