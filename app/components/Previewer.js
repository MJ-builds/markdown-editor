...
export default function Previewer({editorContent}) {
  ...
  return (
    <div>
      <div className="flex items-center justify-between font-r-reg font-medium h-[42px] bg-[#1D1F22] p-4 text-sm tracking-[2px] border-l-[1px] border-[#5A6069]">
        PREVIEW
        <button value={previewToggle} onClick={handleChange} className="text-[#7C8187] hover:text-[#E46643]">
          {!previewToggle ?
      ...
      <ReactMarkdown className="markdown font-r-slab bg-[#151619] border-l-[1px] border-[#5A6069] p-4 w-full h-full resize-none focus:outline-none">
        {/* <Editor /> */}
        {editorContent}
      </ReactMarkdown>
    </div>
